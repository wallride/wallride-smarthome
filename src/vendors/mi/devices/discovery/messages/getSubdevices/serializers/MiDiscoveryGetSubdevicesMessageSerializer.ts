...
import {MiDiscoveryWhoisRequestMessage} from "../../whois/models/MiDiscoveryWhoisRequestMessage";

export class MiDiscoveryGetSubdevicesMessageSerializer extends MiAbstractMessageSerializer<MiDiscoveryWhoisRequestMessage> {
